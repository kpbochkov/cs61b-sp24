...
public class NGramMapTest {
    ...
    public void testTotalCountHistory() {
        ...
        TimeSeries totalCounts = ngm.totalCountHistory();
        assertThat(totalCounts.get(1470)).isEqualTo(984);
    }
    ...
    public void testWeightHistory() {
        ...
        TimeSeries fishWeight = ngm.weightHistory("request", 2005, 2008);
        assertThat(fishWeight.get(2006)).isWithin(1E-7).of(677820.0 / 27695491774.0);
    }
}