...
public class TestBSTMap {
    ...
    @Test
    public void ifSameKeyAndDifferentValuePutShouldOverwrite() {
        BSTMap<String, Integer> b = new BSTMap<>();
        assertThat(b.size()).isEqualTo(0);
        b.put("hi", 1);
        b.put("hi", 2);
        assertThat(b.size()).isEqualTo(1);
        assertThat(b.get("hi")).isEqualTo(2);
    }
    ...
    public void removeLeafTest() {
        ...
        String value = b.remove("c");
        assertThat(b.size()).isEqualTo(4);
        assertThat(value).isEqualTo("swiss");
        assertThat(b.get("c")).isNull();
        assertThat(b.containsKey("c")).isFalse();
    }

    @Test
    public void removeNodeWith2Children() {
        BSTMap<String, String> b = new BSTMap<>();
        b.put("d", "parmesan");
        b.put("a", "mozzarella");
        b.put("c", "swiss");
        ...
        String rootValue = b.remove("d");
        assertThat(b.size()).isEqualTo(6);
        assertThat(rootValue).isEqualTo("parmesan");
        assertThat(b.get("d")).isNull();
        assertThat(b.containsKey("d")).isFalse();
    }
}
