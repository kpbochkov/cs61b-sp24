...
public class TestCommonAncestors {
    ...
    public static final String VERY_SMALL_SYNSET_FILE = "data/wordnet/synsets3.txt";
    public static final String VERY_SMALL_HYPONYM_FILE = "data/wordnet/hyponyms3.txt";
    ...
    public void testSpecAdjustment2() {
        NgordnetQueryHandler studentHandler = AutograderBuddy.getHyponymsHandler(
                WORDS_FILE, TOTAL_COUNTS_FILE, VERY_SMALL_SYNSET_FILE, VERY_SMALL_HYPONYM_FILE);
        List<String> words = List.of("test_subject", "math");
