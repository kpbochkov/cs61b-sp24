...
public class AoAGame {
    ...
    private static final String DICTIONARY_FILE2 = "data/sorted_scrabble.txt";
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Chooser chooser = new RandomChooser(wordLength, DICTIONARY_FILE2);
//        Guesser guesser = new ConsoleGuesser(console);
        Guesser guesser = new PAGALetterFreqGuesser(DICTIONARY_FILE2);
